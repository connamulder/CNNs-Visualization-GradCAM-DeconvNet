...
def main():
    ...
    #img.save('Result{}_{}_{}.png'.format(layer_name, feature_to_visualize, visualize_mode))
    img.save('{}_{}_kernel{}_{}.png'.format(image_path[0:-4],layer_name, feature_to_visualize, visualize_mode))
